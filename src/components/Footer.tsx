      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <Link href="/" className="inline-flex items-center gap-1 text-charcoal">
        ...
        <div className="mt-12 pt-8 border-t border-tan/60 flex justify-center">
          <p className="font-mono text-[11px] uppercase tracking-[0.24em] text-bark/70">{SITE_TAGLINE}</p>
        </div>
      </div>
    </footer>
  );
